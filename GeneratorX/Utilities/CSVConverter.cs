...
//namespace AdstreamRadio.Service.Utilities {
//	class CSVConverter {
//	}
//}
...
//namespace WebUI.Infrastructure {
	...
	public static class EpplusCsvConverter {
		public static void ConvertToCsv(this ExcelPackage package, FileInfo excelfile) {
			string targetFile = excelfile.FullName + ".csv";
