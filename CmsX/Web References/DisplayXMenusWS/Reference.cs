...
namespace clickclickboom.machinaX.blogX.cmsX.DisplayXMenusWS {
    ...
    public partial class DisplayXMenus : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public System.Xml.XmlNode Add(string blogxID, string name, string label, string profile, string display, string parentID, string logo) {
        ...
        /// <remarks/>
        public void AddAsync(string blogxID, string name, string label, string profile, string display, string parentID, string logo) {
            this.AddAsync(blogxID, name, label, profile, display, parentID, logo, null);
        }
        
        /// <remarks/>
        public void AddAsync(string blogxID, string name, string label, string profile, string display, string parentID, string logo, object userState) {
            ...
            this.InvokeAsync("Add", new object[] {
                        ...
                        display,
                        parentID,
                        logo}, this.AddOperationCompleted, userState);
        }
        ...
        public System.Xml.XmlNode Edit(string blogxID, int id, string name, string label, string profile, string display, string parentID, string logo) {
        ...
        /// <remarks/>
        public void EditAsync(string blogxID, int id, string name, string label, string profile, string display, string parentID, string logo) {
            this.EditAsync(blogxID, id, name, label, profile, display, parentID, logo, null);
        }
        
        /// <remarks/>
        public void EditAsync(string blogxID, int id, string name, string label, string profile, string display, string parentID, string logo, object userState) {
            ...
            this.InvokeAsync("Edit", new object[] {
                        ...
                        display,
                        parentID,
                        logo}, this.EditOperationCompleted, userState);
        }
        ...
        public System.Xml.XmlNode AddMenuItem(string blogxID, int MenuID, string Label, string Link, string Display, [System.Xml.Serialization.XmlElementAttribute("Order")] int Order1, string Logo) {
        ...
        /// <remarks/>
        public void AddMenuItemAsync(string blogxID, int MenuID, string Label, string Link, string Display, int Order1, string Logo) {
            this.AddMenuItemAsync(blogxID, MenuID, Label, Link, Display, Order1, Logo, null);
        }
        
        /// <remarks/>
        public void AddMenuItemAsync(string blogxID, int MenuID, string Label, string Link, string Display, int Order1, string Logo, object userState) {
            ...
            this.InvokeAsync("AddMenuItem", new object[] {
                        ...
                        Display,
                        Order1,
                        Logo}, this.AddMenuItemOperationCompleted, userState);
        }
        ...
        public System.Xml.XmlNode EditMenuItem(string blogxID, int MenuID, int MenuItemID, string Label, string Link, string Display, [System.Xml.Serialization.XmlElementAttribute("Order")] int Order1, string Logo) {
        ...
        /// <remarks/>
        public void EditMenuItemAsync(string blogxID, int MenuID, int MenuItemID, string Label, string Link, string Display, int Order1, string Logo) {
            this.EditMenuItemAsync(blogxID, MenuID, MenuItemID, Label, Link, Display, Order1, Logo, null);
        }
        
        /// <remarks/>
        public void EditMenuItemAsync(string blogxID, int MenuID, int MenuItemID, string Label, string Link, string Display, int Order1, string Logo, object userState) {
            ...
            this.InvokeAsync("EditMenuItem", new object[] {
                        ...
                        Display,
                        Order1,
                        Logo}, this.EditMenuItemOperationCompleted, userState);
        }
